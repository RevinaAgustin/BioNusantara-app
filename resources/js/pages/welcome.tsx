...
import { Camera, CheckCircle, Leaf, Map, Search } from 'lucide-react';
        ...
        <AppLayout>
            <div className="relative flex flex-col">
                    ...
                    <div className="container mx-auto px-4 py-20 md:py-32">
                        <motion.div className="mx-auto max-w-3xl text-center" {...fadeUp}>
                            ...
                            <h1 className="mb-6 text-4xl font-bold leading-tight text-foreground md:text-6xl">
                                Jelajahi & Lindungi <span className="text-primary">Biodiversitas</span>{' '}
                                Nusantara
                            </h1>
                            <p className="mb-8 text-lg text-muted-foreground md:text-xl">
                                Bergabunglah dengan ribuan warga dan ilmuwan Indonesia untuk
                                mendokumentasikan kekayaan hayati lokal. Setiap observasi Anda
                ...
                <section className="py-20">
                    <div className="container mx-auto px-4 text-center">
                        ...
                        <p className="mb-12 text-muted-foreground">
                            Tiga langkah sederhana untuk berkontribusi
                        </p>
                ...
                <footer className="border-t border-border/60 py-8 text-center text-sm text-muted-foreground">
                    <div className="mb-2 flex items-center justify-center gap-2 font-medium text-foreground">
